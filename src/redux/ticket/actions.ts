...
export const onBarcodeAction = createAction(ON_BARCODE + START);
...
export const dissociateFeatureTicketAction = createAction(DISSOCIATE_FEATURE_TICKETS + START);
